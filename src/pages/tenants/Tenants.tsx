...
import { Phone, Mail, DollarSign, X } from 'lucide-react';
	...
	return (
		<div className='min-h-screen bg-gray-50'>
			<div className='p-8'>
				...
				<div className='flex justify-between items-center mb-8'>
					...
					<Button
						...
						className='bg-[#b200ff] text-white px-6 py-2 focus-visible:ring-[#000] focus-visible:border-[#000]'
					>
						Add Tenant
					</Button>
				</div>
				...
				<div className='flex gap-4 justify-between mb-6'>
					...
					<Select value={selectedType} onValueChange={setSelectedType}>
						<SelectTrigger className='w-48 border-gray-200 bg-white focus-visible:ring-[#000] focus-visible:border-[#000]'>
			...
			<Dialog open={isDeleteModalOpen} onOpenChange={setIsDeleteModalOpen}>
				<DialogContent className='max-w-md fixed top-11/15 left-11/15 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-white rounded-lg shadow-xl p-6'>
